...
df['price_per_sqft'] = df.apply(lambda row: row['target'] * 100000 / row['area_sqft'], axis=1)
...
df['house_age_group'] = pd.cut(df['HouseAge'], bins=[0, 10, 20, 30, 50], labels=['0-10', '11-20', '21-30', '31-50'])
